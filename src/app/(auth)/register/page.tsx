...
import { registerMember } from '../../auth/register/actions'
    ...
    return (
      <div className="text-center">
        ...
        <p className="text-gray-400 text-sm mb-1">
          Bienvenue <span className="text-white font-medium">{form.fullName}</span> !
        </p>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input name="fullName" type="text" required autoComplete="name"
            value={form.fullName} onChange={handleChange} placeholder="KALONJI Camille"
        ...
        <div>
          ...
          <select name="affiliation" required
            ...
            className="w-full px-4 py-3 bg-[#0A0B10] border border-[#252637] rounded-xl text-white focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent/20 transition-all text-sm">
